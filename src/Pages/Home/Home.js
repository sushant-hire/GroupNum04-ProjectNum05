...
// It initializes two state variables, "zoomLevel" and "image", using the "useState" hook.
// It also initializes a ref variable "fileInputRef" using the "useRef" hook.
function Home() {
  // State
  ...
  async function handleDownload() {
    ...
    pdfDoc.save("document.pdf"); // Saves the PDF document as "document.pdf"
  }
